...
import { Search, Users, Handshake, MessageSquare, Files, FileCheck2, Leaf, Truck, Route, PackageCheck, CreditCard, History, Repeat2, ChevronDown } from "lucide-react";

const journey = [
  { title: "Business discovery", text: "Find relevant, vetted opportunities.", icon: Search },
  { title: "Buyer + seller", text: "Qualified parties enter a private process.", icon: Users },
  { title: "Deal Room", text: "A secure workspace holds the transaction.", icon: Handshake, branch: true },
  { title: "Contract signed", text: "Agreed terms become a clear record.", icon: FileCheck2 },
  { title: "Green Africa", text: "Applied when sustainability criteria are relevant.", icon: Leaf, optional: true },
  { title: "Logistics Centre", text: "Compare routes and coordinate movement.", icon: Truck },
  { title: "Carrier selected", text: "Choose the right transport provider.", icon: Route },
  { title: "Shipment", text: "Goods begin moving across the corridor.", icon: Truck },
  { title: "Tracking + updates", text: "Both sides follow progress and exceptions.", icon: Route },
  { title: "Border / delivery", text: "Documentation and handover are recorded.", icon: PackageCheck },
